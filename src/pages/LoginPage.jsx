...
export default function LoginPage({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!username.trim()) { setError('Vui lòng điền tài khoản.'); return; }
    if (!password)        { setError('Vui lòng điền mật khẩu.'); return; }
          ...
          <div className="form-container">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="form-group">
                <label className="input-label" htmlFor="login-username">Tài khoản</label>
