...
export default function AdminDashboard({ user, onLogout }) {
  ...
  const handleSaveMentor = async (mentor) => {
    ...
    try {
      ...
      showToast(
        isEdit ? "Đã cập nhật mentor thành công!" : "Đã thêm mentor mới!",
      );
    } catch (err) {
  ...
  const exportExcel = () => {
    ...
    const ws2 = XLSX.utils.json_to_sheet(
      regRows.length ? regRows : [{ "Ghi chú": "Chưa có đăng ký nào" }],
    );
    ...
    XLSX.writeFile(
      wb,
      `DangKyMentor_${new Date().toISOString().slice(0, 10)}.xlsx`,
    );
          ...
          <div className="ad-page">
            ...
            <div className="ad-page-header">
              <div>
                ...
                <p className="ad-page-sub">
                  Tổng số: <strong>{mentors.length} mentor</strong>
                </p>
              </div>
              <button
            ...
            {filteredMentors.length === 0 ? (
              <div className="ad-empty">
                ...
                <p>
                  Chưa có mentor nào. Nhấn <strong>+ Thêm Mentor</strong> để bắt
                  đầu.
                </p>
              </div>
            ) : (
              <div className="ad-mentor-grid">
                {filteredMentors.map((m) => {
                  ...
                  const pct =
                    m.maxSlots > 0
                      ? Math.round((registered / m.maxSlots) * 100)
                      : 0;
                    ...
                    <div key={m.id} className="amc-card">
                      ...
                      <div className="amc-progress-section">
                        <div className="amc-progress-row">
                          ...
                          <span className="amc-progress-count">
                            {registered}/{m.maxSlots}
                          </span>
                        </div>
          ...
          <div className="ad-page">
            ...
            <div className="ad-page-header">
              <div>
                ...
                <p className="ad-page-sub">
                  Tổng số: <strong>{users.length} thành viên</strong>
                </p>
              </div>
              <button
                className="ad-btn-primary"
                  ...
                  <tbody>
                    {filteredUsers.map((u, index) => (
                      <tr key={u.id || index}>
                        ...
                        <td className="td-mssv">
                          <span className="mssv-badge">{u.username}</span>
                        </td>
                        ...
                        <td>
                          <span
                            className={`ad-role-badge ${u.role === "admin" ? "role-admin" : "role-user"}`}
                          >
      ...
      {deleteMentorId && (
        <div className="modal-overlay" onClick={() => setDeleteMentorId(null)}>
          <div className="confirm-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              Hành động này không thể hoàn tác và sẽ xoá toàn bộ dữ liệu đăng ký
              của mentor này.
            </p>
            <div className="confirm-actions">
              <button
                className="btn-cancel"
                onClick={() => setDeleteMentorId(null)}
              >
                Huỷ
              </button>
              <button
