...
export default function UserModal({ show, onClose, onSave, editUser }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (!username.trim()) {
      setError("Vui lòng nhập MSSV (tài khoản).");
      return;
    }
    if (!password) {
          ...
          <div className="modal-body">
            ...
            <div className="form-group">
              <label className="modal-label" htmlFor="user-username">
                MSSV (Tài khoản đăng nhập) <span className="req">*</span>
              </label>
              <input
                type="text"
                id="user-username"
            ...
            {/* Vai trò */}
            <div className="form-group">
              <label className="modal-label" htmlFor="user-role">
                Vai trò hệ thống
              </label>
              <select
                id="user-role"
              ...
              >
                <option value="user">
                  👤 Thành viên (Mentee/Thành viên CLB)
                </option>
